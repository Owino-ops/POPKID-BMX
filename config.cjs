...
const config = {
  SESSION_ID: process.env.SESSION_ID || "POPKID~9OlXjDKR#kXz2Pp5EsYzkhtCIE4zsLU421OTOkhZvAveFXNhIb_M",
  ...
  ANTI_DELETE: process.enconst fs = require("fs");
require("dotenv").config();
...
v.ANTI_DELETE !== undefined ? process.env.ANTI_DELETE === 'true' : true,
  MENU_IMAGE: process.env.MENU_IMAGE || "https://files.catbox.moe/htnkaq.jpg",
  BOT_NAME: process.env.BOT_NAME || "Sarkar",
  DELETE_PATH: process.env.DELETE_PATH || "pm",
  MODE: process.env.MODE || "public",
